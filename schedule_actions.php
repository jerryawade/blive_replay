...
class ScheduleManager {
    ...
    public function getSchedules() {
        ...
        foreach ($schedules as &$schedule) {
            if ($schedule['type'] === 'once' && $schedule['enabled']) {
                try {
                    // Combine date and end time to create the schedule end datetime
                    $scheduleEndDateTime = new DateTime($schedule['date'] . ' ' . $schedule['endTime']);
     ...
     * @param string $username User who added the schedule
     ...
     * @param string $username User who updated the schedule
     * @return array Result with success status and message
     */
     ...
     * @param string $username User who deleted the schedule
     * @return array Result with success status and message
     */
